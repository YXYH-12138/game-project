...
export class BulletPlugin implements IPlayerPlugin {
  id = "bullet";
...
export class AutoShootPlugin implements IPlayerPlugin {
  id = "AutoShoot";
  ...
  /** 发射间隔，单位ms */
  private _fireInterval = 10;
  /** 发射定时器 */
  private _timer = 0;
  /** 子弹速度 */
  private _bulletSpeed = 6;
  /** 子弹生命周期，单位ms */
  ...
  private fire() {
    const { x, y } = this._player.container;
    ...
    this._player.app.stage.addChild(bulletSprite);
